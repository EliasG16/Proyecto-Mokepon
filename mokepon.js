...
function unirseAlServidor() {
    fetch("http://192.168.1.170:8080/unirse").then(function (res) {
        if (res.ok) {
...
function revisarVidas(){
    if(victoriasJugador===victoriasEnemigo){
        ...
        crearMensajeFinal("¡FELICITACIONES! Acabas de ganar")
    }else{
        crearMensajeFinal('Has perdido...sigue intentandolo')
        }
}
